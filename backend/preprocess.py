...
def extract_metadata(post):
    ...
    1. Returan a valid JSON. No preamble.
    2. JSON object should have exactly three keys: line_count, language and tags
    3. tags is an arrat of text tags. Extract maximum two tags.
    4. Language should be enlish of Hinglish (Hinglish meand Hindi + English)
...
if __name__ == "__main__":
    preprocess_posts('data/raw_posts.json','data/processed_posts.json')